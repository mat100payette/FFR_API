...
from services.blackbox_calc_api_service import get_complete_ffr_estimates
from services.ffr_api_service import (
    get_all_charts,
...
def run(args):
    ...
    if isinstance(args, BlackBoxCalcArgs):
        return get_complete_ffr_estimates(args)
